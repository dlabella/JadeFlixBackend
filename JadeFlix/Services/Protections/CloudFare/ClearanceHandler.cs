...
namespace Jadeflix.Services.Protections.CloudFare
{
    ...
    public class ClearanceHandler : DelegatingHandler
    {
        ...
        private static bool IsClearanceRequired(HttpResponseMessage response)
        {
            ...
            var isCloudFlareServer = response.Headers.Server.Any(i => i.Product != null && CloudFlareServerNames.Any(s => string.Compare(s, i.Product.Name, System.StringComparison.OrdinalIgnoreCase) == 0));
